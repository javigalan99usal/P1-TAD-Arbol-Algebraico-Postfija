...
void pilaInserta(Arbol dato, Pila* pila); // Inserta un elemento al final de la pila
Arbol pilaSuprime(Pila* pila); // Suprime el elemento que está al final de la pila y devuelve su valor
